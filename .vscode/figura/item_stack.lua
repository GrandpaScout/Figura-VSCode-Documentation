...
---Returns the amount of time needed to spend before the item is completely used.
---@return number
...
---Returns if the item is able to be enchanted in an enchanting table or anvil.
---@return boolean
